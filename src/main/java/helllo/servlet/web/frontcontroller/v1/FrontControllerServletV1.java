...
import helllo.servlet.web.frontcontroller.v1.controller.MemberListControllerV1;
...
@WebServlet(name = "frontControllerServletV1", urlPatterns = "/front-controller/v1/*") ///front-controller/v1 을 포함한 하위 요청은 이 서블릿에서 받아드린다.
